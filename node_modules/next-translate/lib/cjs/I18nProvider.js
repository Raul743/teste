...
exports.InternalContext = react_1.createContext({ ns: {}, config: {} });
function I18nProvider(_a) {
    ...
    var parentLang = useTranslation_1.default().lang;
    var _d = router_1.useRouter() || {}, locale = _d.locale, defaultLocale = _d.defaultLocale;
    var lang = lng || parentLang || locale || defaultLocale || '';
    var internal = react_1.useContext(exports.InternalContext);
    ...
    var t = transCore_1.default({ config: config, allNamespaces: allNamespaces, pluralRules: pluralRules });
