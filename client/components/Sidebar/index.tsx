      ...
      <div data-simplebar="init" className="h-100">
        <div className="simplebar-wrapper" style={{ margin: '0px;' }}>
          ...
          <div className="simplebar-mask">
            <div className="simplebar-offset" style={{ right: '-14px', bottom: '0px' }}>
              <div
...
//has-arrow waves-effect
   if(index ==0){
    return (
      <li>
      <a href="/" onClick={(e)=>{e.preventDefault(); activateParentDropdown(index)}} className="waves-effect">
        <i className="bx bx-home-circle"></i>
        <span className="badge rounded-pill bg-info float-end">0{index}</span>
        <span key="t-dashboards">{dados.nome}</span>
      </a>
      {(dados?.outlet &&
        
        
        <ul className={  menu == index ? `sub-menu mm-collapse mm-show` : `sub-menu mm-collapse`} aria-expanded="false">
     ...
     return (
      ...
      <li>
      <a href="/" onClick={(e)=>{e.preventDefault(); activateParentDropdown(index)}} className={dados?.outlet ? "has-arrow waves-effect" :""}>
      ...
      {(dados?.outlet &&
        ...
        <div className="simplebar-track simplebar-vertical" style={{ visibility: 'visible' }}>
          <div
            className="simplebar-scrollbar"
            style={{ height: '60px', transform: 'translate3d(0px, 0px, 0px)', display: 'block' }}
          ></div>
        </div>
      </div>
    </div>
