      ...
      <Card>
        ...
        <CardFooter className="bg-transparent border-top">
          <div className="text-center">
            <Link href="#">
              <a className="btn btn-outline-light me-2 w-md"> Deposit</a>
            </Link>{" "}
            <Link href="#">
              <a className="btn btn-primary me-2 w-md">Buy / Sell</a>
            </Link>
          </div>
        </CardFooter>
      </Card>
