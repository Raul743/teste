                        ...
                        <Link href="#" >
                          <a className="subject">
                            ...
                            <span className="teaser">
                              Trip home from Colombo has been arranged, then Jenna will come get me
                              from Stockholm. :)
                            </span>
                          </a>
                        </Link>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link href="#" >
                          <a className="subject">
                            ...
                            <span className="teaser">
                              Alright thanks. I'll have to re-book that somehow, i'll get back to
                              you.
                            </span>
                          </a>
                        </Link>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link href="#" >
                          <a className="subject">
                            ...
                            Off on Thursday -
                            <span className="teaser">
                              Eff that place, you might as well stay here with us instead! Sent from
                              my iPhone 4 4 mar 2014 at 5:55 pm
                            </span>
                          </a>
                        </Link>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link href="#" >
                          <a className="subject">
                            ...
                            <span className="teaser">
                              To create this month's pack, we hosted a party with local musician
                              Jared Mahone here in Columbus, Ohio.
                            </span>
                          </a>
                        </Link>
                        <div className="date">Feb 28</div>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link href="#" >
                          <a className="subject">
                            ...
                            <span className="teaser">
                              Yeah i'd like that! Do you remember the video you showed me of your
                              train ride between Colombo and Kandy? The one with the mountain view?
                      ...
                      <div className="col-mail col-mail-2">
                        <Link href="#" >
                          <a className="subject">
                            ...
                            <span className="teaser">
                              You've been confirmed! Welcome to the ruling className of the inbox.
                      ...
                      <div className="col-mail col-mail-2">
                        <Link href="#" >
                          <a className="subject">
                            ...
                            <span className="teaser">
                              Hej Nicklas Sandell! Vi vill bjuda in dig till "First tour 2014", ett
                              rekryteringsevent som erbjuder jobb på 16 semesterorter iSverige.
                            </span>
                          </a>
                        </Link>
                        <div className="date">Mar 8</div>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link href="#" >
                          <a className="subject">
                            ...
                            Weekend on Revibe –
                            <span className="teaser">
                              Today's Friday and we thought maybe you want some music inspiration
                              for the weekend. Here are some trending tracks and playlists we think
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link href="#">
                          <a className="subject">
                            Hey man –
                            <span className="teaser">Nah man sorry i don't. Should i get it?</span>
                          </a>
                        </Link>
                        <div className="date">Feb 23</div>
                      </div>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link href="#" >
                          <a className="subject">
                            ...
                            <span className="teaser">
                              The following items were added to your Stack Exchange global inbox
                      ...
                      <div className="col-mail col-mail-2">
                        <Link href="#" >
                          <a className="subject">
                            Train/Bus –
                            <span className="teaser">
                              Yes ok, great! I'm not stuck in Stockholm anymore, we're making
                              progress.
                            </span>
                          </a>
                        </Link>
